...
public interface Import extends Node
{
	...
	class Impl extends Node.Impl implements Import
	{
		...
		// =============== Methods ===============
		@Override public <P, R> R accept(Import.Visitor<P, R> visitor, P par) { return visitor.visitImport(this, par); }
		@Override public <P, R> R accept(Node.Visitor<P, R> visitor, P par) { return visitor.visitImport(this, par); }
